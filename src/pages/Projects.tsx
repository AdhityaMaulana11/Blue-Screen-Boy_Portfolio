...
const Projects = () => {
  ...
  // Sequential: first the heading, then each project card one by one
  ...
  const getOnComplete = (index: number) =>
    index === activeIndex ? () => setActiveIndex((i) => i + 1) : undefined;
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
          {projects.map((project, i) => {
            const seqIndex = i + 1; // 0 is the heading
            if (devMode && !isActive(seqIndex)) return null;
            ...
            return (
              ...
              >
                <TerminalReveal
                  ...
                  active={isActive(seqIndex)}
                  onComplete={getOnComplete(seqIndex)}
                >
                  <Link
